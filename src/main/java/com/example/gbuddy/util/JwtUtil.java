...
public class JwtUtil {
    ...
    public String generateToken(String username) throws CustomException {
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) throws CustomException {
        try {
